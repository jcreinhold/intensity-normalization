...
htmlhelp_basename = 'intensity-normalizationdoc'
...
latex_documents = [
    (master_doc, 'intensity-normalization.tex', 'intensity-normalization Documentation',
...
man_pages = [
    (master_doc, 'intensity-normalization', 'intensity-normalization Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'intensity-normalization', 'intensity-normalization Documentation',
     author, 'intensity-normalization', 'One line description of project.',
     'Miscellaneous'),
]
