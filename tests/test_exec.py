...
class TestCLI(unittest.TestCase):
    def setUp(self):
        ...
        self.cli_args = f"-i {self.data_dir} -b {self.mask_dir} -o {self.out_dir}".split()
    ...
    def test_fcm_normalization_cli(self):
        ...
        args = f"-i {self.data_dir}/test.nii.gz -b {self.mask_dir}/mask.nii.gz -s -o {self.out_dir}".split()
        retval = fcm(args)
        self.assertEqual(retval, 0)
    ...
    def test_nyul_normalization_save_sh_cli(self):
        ...
        args = self.cli_args + f"-sh {self.out_dir}/sh.npy".split()
        retval = nyul(args)
        self.assertEqual(retval, 0)
        retval = nyul(args)
        self.assertEqual(retval, 0)
    ...
    def test_ravel_normalization_cli_no_register(self):
        ...
        args = self.cli_args + ["--no-registration", "-s", "0.1"]
        retval = ravel(args)
        self.assertEqual(retval, 0)
    ...
    def test_ravel_normalization_cli_fcm(self):
        ...
        args = self.cli_args + ["--no-registration", "--use-atropos"]
        retval = ravel(args)
        self.assertEqual(retval, 0)
    ...
    def test_norm_quality_cli(self):
        ...
        args = f"-i {self.data_dir} -b {self.mask_dir} -o {self.out_dir}/pairwisejsd.png".split()
    ...
    def test_plot_hists_cli(self):
        ...
        args = (
            f"-i {self.data_dir} -b {self.mask_dir} -o {self.out_dir}/hist.png".split()
        )
    ...
    def test_tissue_mask_cli(self):
        ...
        args = self.cli_args + ["--memberships"]
